...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, input_chlnum, denoisemean, latent_size=512, denoise=[True,True,True,True,True]):
        ...
        self.conv1 = nn.Conv2d(input_chlnum, 64, kernel_size=3, stride=1, padding=1, bias=False)
...
def ResnetEncoder(input_chlnum, denoisemean, latent_size, denoise):
    return ResNet(block=BasicBlock, num_blocks=[2,2,2,2], input_chlnum=input_chlnum, denoisemean=denoisemean, latent_size=latent_size, denoise=denoise)
